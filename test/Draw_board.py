...
def main(x,y):
    ...
    #scale x and y coords to the board size
    #point = (int(x),int(y))
    #point = (np.float32(width - x),np.float32(height - y))
   #sector numbers
    ...
    print ("Outer Double", mults[0])
    #mult line positions
    #mults = [530,491,332,276,55,15]
    #mults = [265,245,166,138,27,7]
    #mults = [378,356,233,211,33,11] 
    #mults = [340,320,210,190,35,15]
    #mults = [47.22,44.44,29.16,26.39,4.17,1.39]
    #mults = [590,556,365,330,52,17]
    #mults = [236,222,146,132,21,14] 
    c_x = int(width/2)
    c_y = int(height/2)
